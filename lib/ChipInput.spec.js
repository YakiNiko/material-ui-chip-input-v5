...
describe('uncontrolled mode', function () {
  it('matches the snapshot', function () {
    var tree = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ChipInput["default"], {
  ...
  it('calls inputRef when it set', function () {
    ...
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ChipInput["default"], {
  ...
  it('set defaultValue asynchronously after first render', function () {
    var tree = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ChipInput["default"], null));
    tree.setProps({
      defaultValue: ['Foo', 'Bar']
...
describe('blurBehavior modes', function () {
  ...
  it('adds the input on blur with blurBehavior set to add add-or-clear, if onBeforeAdd passes', function () {
    var handleChange = jest.fn();
    var tree = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ChipInput["default"], {
      defaultValue: ['a', 'b'],
      onChange: handleChange,
      blurBehavior: "add-or-clear",
      onBeforeAdd: function onBeforeAdd(value) {
        return value === 'c';
      }
    }));
  ...
  it('clears the input on blur with blurBehavior set to add-or-clear, if onBeforeAdd fails', function () {
    var tree = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ChipInput["default"], {
      defaultValue: ['a', 'b'],
      blurBehavior: "add-or-clear",
      onBeforeAdd: function onBeforeAdd(value) {
